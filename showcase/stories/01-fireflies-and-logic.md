...
## Chapter 2: The AND Dance

They flew in a circle and counted: "One... two... THREE!"

Both fireflies lit up together: **BLUE + ORANGE = BRILLIANT WHITE**

A sign appeared in the air, written in starlight:

```
✦ AND GATE ✦
Both Hope AND Sauce must shine
...
## Chapter 3: The OR Choice

Next, they found a different flower, glowing soft green.
...
The starlight sign appeared again:

```
✦ OR GATE ✦
Hope OR Sauce (or both!)
Any light makes the flower glow
```
...
## Chapter 4: The NOT Mystery

Then they found the strangest flower of all: it glowed bright purple when they were **dark**, but went dim when they shined!
...
## Chapter 5: The XOR Secret

The final flower was golden, and it was the trickiest of all.

It only glowed when **exactly one** firefly was lit:

- Hope shines, Sauce dark → Golden glow! ✓
- Sauce shines, Hope dark → Golden glow! ✓
- Both shine → No glow ✗
- Both dark → No glow ✗
...
## Chapter 6: Building the Logic Garden
...
## 🎮 Your Turn: Build the Logic Gates!

**Minecraft Museum Build Mission:**

1. Read this story first ✓ (You just did!)
2. Download `logic-gates.json` from the museum
3. Use WorldEdit or Litematica to import the build
4. Test each gate with levers (inputs) and redstone lamps (outputs)
