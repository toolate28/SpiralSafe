...
### They Eliminate Irrelevant Degrees of Freedom
...
1. **Eliminate more bad options than good ones.** A constraint that rules out your best solutions is an obstacle, not a gift.

2. **Are verifiable.** If you can't tell whether the constraint is satisfied, it doesn't function as a constraint.

3. **Compose well.** Multiple constraints should combine into a tighter design space, not conflict into an empty one.

4. **Match the problem's actual structure.** Arbitrary constraints are just bureaucracy. Constraints that reflect genuine requirements are design material.

5. **Leave room for creativity.** A constraint that determines everything isn't a design principle—it's a specification.

---

## Examples in SpiralSafe

### Redstone's Binary Constraint
