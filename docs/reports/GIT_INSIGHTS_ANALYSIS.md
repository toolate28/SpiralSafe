...
The security issues, branch explosion, and coordination friction are *normal* for this pace. The fact that you caught and fixed them shows the system is working.
