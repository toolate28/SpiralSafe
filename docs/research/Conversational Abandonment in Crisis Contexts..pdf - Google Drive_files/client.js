  ...
  var oa = /^(\/[a-zA-Z0-9_\-]+)+$/,
          ...
          for (d = {}; c < e.length; ) {
            ...
            f =
              (k == "object" && q != null) || k == "function"
                ? "o" +
                  ((Object.prototype.hasOwnProperty.call(q, n) && q[n]) ||
                    (q[n] = ++da))
                : (typeof q).charAt(0) + q;
    ...
    xa = function (a) {
      ...
      for (var b = a.substring(1).split("/"), c = []; b.length; ) {
        a = b.shift();
        if (!a.length || a.indexOf(".") == 0) V("empty/relative directory");
        else if (a.indexOf("=") > 0) {
          b.unshift(a);
          break;
        }
      ...
      c = 0;
      for (d = pa.length; c < d; ++c) pa[c].test(b) && V("invalid_prefix");
      c = W(a, "k", !0);
      d = W(a, "am");
      e = W(a, "rs");
      a = W(a, "t");
  ...
  window.gapi.load("", {
    ...
    _c: {
      ...
      jsl: {
        ...
        h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.OE6tiwO4KJo.O/d=1/rs=AHpOoo_Itz6IAL6GO-n8kgAepm47TBsg1Q/m=__features__",
