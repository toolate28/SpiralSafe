...
*/
    ...
    if (c) {
      ...
      if (this.A)
        for (g = 0; g < c.length; g++)
          ((k = c[g]), hb(this.g[k + 1], this.g[k + 2], d));
      else {
        this.m++;
        try {
      ...
      ua(["debugjs", "debugcss"], function (k) {
        ...
        b: {
          ...
          for (var h = k.length; (e = g.indexOf(k, e)) >= 0 && e < f; ) {
            ...
            if (l == 38 || l == 63)
              if (
                ((l = g.charCodeAt(e + h)), !l || l == 61 || l == 38 || l == 35)
              )
                break b;
            e += h + 1;
          }
                ...
                ? (a[d.u] = (function (k) {
                    return function () {
                      ...
                      return this.playerInfo[
                        g.charAt(f).toLowerCase() + g.substring(f + 1)
                      ];
                    };
                  })(d))
                : (a[d.u] = (function (k) {
  ...
  function Kb(a) {
    if (a.tagName.toLowerCase() !== "iframe") {
      var b = tb(a, "videoid");
      b &&
        ((b = { videoId: b, width: tb(a, "width"), height: tb(a, "height") }),
        new X(a, b));
    }
  }
  function Fb(a, b, c) {
