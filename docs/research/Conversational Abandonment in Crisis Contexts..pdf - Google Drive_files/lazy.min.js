    ...
    ua = function (a) {
      for (; a.context_.nextAddress; )
        try {
          ...
          if (b)
            return ((a.context_.isRunning_ = !1), { value: b.value, done: !1 });
        } catch (c) {
...
*/
  ...
  function Ua(a) {
    if (a instanceof Sa) return a.privateDoNotAccessOrElseWrappedResourceUrl;
    throw Error("");
  }
  var Va = function (a) {
  ...
  var Wa = new Va("about:invalid#zClosurez");
  function Xa(a) {
    if (a instanceof Va) return a.privateDoNotAccessOrElseWrappedUrl;
    throw Error("");
  }
  function B(a, b) {
  ...
  var ab = Fa(748402147, !0),
    bb = Fa(824656860, Fa(1, !0));
  function cb() {
    var a = z.navigator;
  ...
  var ib =
      cb().toLowerCase().indexOf("webkit") != -1 && cb().indexOf("Edge") == -1,
  ...
  function Eb(a, b) {
    return b === void 0
      ? a.copyOnWrite !== Fb &&
          !!(
            2 &
            (a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows[C] | 0)
          )
  ...
  function F(a) {
    ...
    return Nb
      ? BigInt(a)
      : (a = Lb(a) ? (a ? "1" : "0") : Kb(a) ? a.trim() || "0" : String(a));
  }
  ...
  function dc(a, b) {
    if (a != null) {
      ...
      c = d[a] || 0;
      c >= b || ((d[a] = c + 1), (a = Error()), ac(a, "incident"), Za(a));
    }
  }
  function ec(a) {
    ...
    if (a.length < 16) Wb(Number(a));
      ...
      for (
        ...
        ((d = Number(a.slice(d, e))),
          ...
          (G = G * 1e6 + d),
          G >= 4294967296 &&
            ((H += Math.trunc(G / 4294967296)), (H >>>= 0), (G >>>= 0)));
      b &&
        ((b = w(Xb(G, H))),
        (a = b.next().value),
        (b = b.next().value),
  ...
  function tc(a) {
    ...
    b = a.indexOf(".");
    b !== -1 && (a = a.substring(0, b));
    return nb() ? F(fc(64, BigInt(a))) : F(wc(a));
  }
  function uc(a) {
  ...
  function Bc(a, b, c) {
    ...
    d &&
      ...
      (d = Na(rb)) && d in a && (a = a[d]) && delete a[b]);
  }
  function Cc(a, b) {
    var c = Na(rb),
      d;
  ...
  function Ec(a, b, c, d) {
    ...
    var f = Na(rb),
      g;
    !e && ob && f && (g = a[f]) && g.forEachUnknownField(Dc);
    f = [];
    var h = a.length;
    g = 4294967295;
    var k = !1,
    ...
    if (!(b & 1)) {
      ...
      if (l && !(b & 128) && !e) {
        k = !0;
        var r;
        g = ((r = Fc) != null ? r : Hb)(g - n, n, a, q, void 0) + n;
      }
    }
    b = void 0;
    for (e = 0; e < h; e++)
  ...
  function Gc(a) {
    switch (typeof a) {
      ...
      case "object":
        if (Array.isArray(a)) {
          var b = a[C] | 0;
          return a.length === 0 && b & 1 ? void 0 : Ec(a, b, Gc);
        }
        if (a != null && a[wb] === Db) return Hc(a);
        return;
    }
    return a;
  }
  ...
  function Kc(a, b) {
    ...
    if (a != null && a[wb] === Db)
      return (
        ...
        (c = b[C] | 0),
        Eb(a, c) ? a : Mc(a, b, c) ? Nc(a, b) : Lc(b, c)
      );
  }
  function Nc(a, b, c) {
  ...
  function Pc(a) {
    if (
      !Oc(a) &&
      Eb(a, a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows[C] | 0)
    )
      throw Error();
  }
  function Qc(a, b) {
  ...
  var Rc = F(0),
    ...
    Uc = function (a, b, c, d, e) {
      ...
      b = Tc(a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows, b, c, e);
  ...
  function Xc(a, b, c, d, e) {
    ...
    a = 4 & l ? !1 : !0;
    if (a) {
      4 & l && ((h = ec(h)), (k = 0), (l = Yc(l, g)), (g = Vc(f, g, b, h)));
    ...
    d === 1 || (d !== 4 ? 0 : 2 & h || (!(16 & h) && 32 & g))
      ? Zc(h) ||
        ((h |=
          !c.length || (a && !(4096 & h)) || (32 & g && !(4096 & h || 16 & h))
            ? 2
            : 256),
        h !== k && E(c, h),
        Object.freeze(c))
      : (d === 2 &&
          Zc(h) &&
          ((c = ec(c)), (k = 0), (h = Yc(h, g)), (g = Vc(f, g, b, c))),
        Zc(h) || (e || (h |= 16), h !== k && E(c, h)));
    2 & h || !(4096 & h || 16 & h) || Qc(f, g);
    return c;
  }
  function Zc(a) {
  ...
  function $c(a, b, c, d) {
    ...
    k || (g = 0);
    l || ((c = ec(c)), (h = 0), (g = Yc(g, f)), (l = !1));
    g |= 5;
    k = 4 & g ? (512 & g ? 512 : 1024 & g ? 1024 : 0) : void 0;
    k = k != null ? k : bb ? 1024 : 0;
    g |= k;
    for (var n = 0; n < c.length; n++) {
      var q = c[n],
        r = d(q, k);
      Object.is(q, r) ||
        (l && ((c = ec(c)), (h = 0), (g = Yc(g, f)), (l = !1)), (c[n] = r));
    }
    g !== h && (l && ((c = ec(c)), (g = Yc(g, f))), E(c, g));
    Vc(e, f, b, c);
    return a;
  }
  function K(a, b, c, d) {
    Pc(a);
    var e = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows;
    Vc(e, e[C] | 0, b, (d === "0" ? Number(c) === 0 : c === d) ? void 0 : c);
    return a;
  }
  function ad(a, b, c, d, e) {
    var f = !1;
    d = Tc(a, d, e, function (g) {
    ...
    if (d != null) return (f && !Eb(d) && Qc(a, b), d);
  }
  var L = function (a, b, c) {
    ...
    M = function (a, b, c, d) {
      ...
      d &&
        !Eb(d) &&
        Qc(a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows);
      return a;
    };
  function Yc(a, b) {
  ...
  var N = function (a, b) {
    ...
    dd = function (a) {
      return Xc(a, 4, oc, void 0 === Gb ? 2 : 4);
    },
    P = function (a, b, c) {
      if (c != null && typeof c !== "boolean")
        throw Error("Expected boolean but got " + Ga(c) + ": " + c);
      return K(a, b, c, !1);
    };
  ...
  Q.prototype.getExtension = function (a) {
    ...
    Bc(this, a.fieldIndex, a.lazyParse);
    return a.ctor
      ? a.isRepeated
        ? a.getExtensionFn(
            this,
  ...
  Q.prototype.hasExtension = function (a) {
    ...
    if (a.ctor) {
      ...
      a = ad(b, b[C] | 0, a.ctor, a.fieldIndex, a.hasMessageId) !== void 0;
    } else
      (Cc(
        this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
        a.fieldIndex,
  ...
  var ld = function (a, b) {
    this.stringConstValueWithSecurityContract__googStringSecurityPrivate_ =
      (a === jd && b) || "";
    this.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ = kd;
  };
  ...
  var md = function (a) {
      return a instanceof ld &&
        a.constructor === ld &&
        a.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ === kd
  ...
  function qd(a) {
    var b = b === void 0 ? pd : b;
    a: if (((b = b === void 0 ? pd : b), !(a instanceof Va))) {
      for (var c = 0; c < b.length; ++c) {
        var d = b[c];
        if (d instanceof nd && d.isValid(a)) {
          a = new Va(a);
          break a;
        }
      }
  ...
  function sd(a) {
    a = a instanceof Va ? Xa(a) : rd.test(a) ? a : void 0;
    return a;
  }
  function td(a, b) {
    b = sd(b);
  ...
  function vd(a, b) {
    a.src = Ua(b);
    (b = ud(a.ownerDocument)) && a.setAttribute("nonce", b);
  }
  var wd =
  ...
  var zd = function (a) {
      return a ? new xd(yd(a)) : Ya || (Ya = new xd());
    },
    Bd = function (a, b) {
      fd(b, function (c, d) {
        d == "style"
  ...
  var ee = function (a, b) {
    ...
    be = function (a, b) {
      a.callbackEntries_ || (a.state_ != 2 && a.state_ != 3) || he(a);
      ...
      e.child = new U(function (f, g) {
        ...
        e.onRejected = c
          ? function (h) {
              try {
                var k = c.call(d, h);
                k === void 0 && h instanceof de ? g(h) : f(k);
              } catch (l) {
                g(l);
              }
            }
  ...
  var Ud = function (a, b, c) {
    ...
    he = function (a) {
      a.executing_ || ((a.executing_ = !0), Pd(a.executeCallbacks_, a));
    },
    fe = function (a) {
      var b = null;
      a.callbackEntries_ &&
  ...
  U.prototype.executeCallbacks_ = function () {
    for (var a; (a = fe(this)); ) ge(this, a, this.state_, this.result_);
    this.executing_ = !1;
  };
  var ge = function (a, b, c, d) {
      ...
      if (b.child) ((b.child.parent_ = null), ke(b, c, d));
      else
        try {
          b.always ? b.onFulfilled.call(b.context) : ke(b, c, d);
        } catch (e) {
          le.call(null, e);
        }
      Wd.put(b);
    ...
    je = function (a, b) {
      ...
      Pd(function () {
        a.hadUnhandledRejection_ && le.call(null, b);
      });
    },
    le = Za,
    de = function (a) {
...
*/
  ...
  V.prototype.cancel = function (a) {
    if (this.fired_) this.result_ instanceof V && this.result_.cancel();
      ...
      this.fired_ || ((a = new me(this)), ne(this), oe(this, !1, a));
    }
  };
  ...
  var oe = function (a, b, c) {
    ...
    ne = function (a) {
      if (a.fired_) {
        if (!a.silentlyCanceled_) throw new qe(a);
  ...
  var ue = function (a) {
    ...
    te = {},
    pe = function (a) {
      if (a.unhandledErrorId_ && a.fired_ && ue(a)) {
        var b = a.unhandledErrorId_,
          c = ve[b];
        c && (z.clearTimeout(c.id_), delete ve[b]);
      ...
      for (var d = (c = !1); a.sequence_.length && !a.blocked_; ) {
        ...
        if ((f = a.hadError_ ? g : f))
          try {
            ...
            if (
              Td(b) ||
              (typeof z.Promise === "function" && b instanceof z.Promise)
            )
              ((d = !0), (a.blocked_ = !0));
          } catch (k) {
            ((b = k), (a.hadError_ = !0), ue(a) || (c = !0));
          }
      }
      a.result_ = b;
      d &&
        ((h = Ma(a.continue_, a, !0)),
        (d = Ma(a.continue_, a, !1)),
        b instanceof V ? (re(b, h, d), (b.blocking_ = !0)) : b.then(h, d));
      c && ((b = new we(b)), (ve[b.id_] = b), (a.unhandledErrorId_ = b.id_));
    },
    se = function (a) {
      var b = new V();
      a.then(
  ...
  var we = function (a) {
    this.id_ = z.setTimeout(Ma(this.throwError, this), 0);
    this.error_ = a;
  };
  ...
  var ve = {};
  var Be = function () {
      var a = Ta("https://apis.google.com/js/client.js"),
        b = {},
        c = b.document || document,
        d = Ua(a).toString(),
        e = new xd(c).createElement("SCRIPT"),
      ...
      k > 0 &&
        ((h = window.setTimeout(function () {
          ye(e, !0);
          var l = new ze(1, "Timeout reached for loading script " + d);
          ne(g);
          oe(g, !1, l);
        }, k)),
        (f.timeout_ = h));
      e.onload = e.onreadystatechange = function () {
        (e.readyState &&
          ...
          (ye(e, b.cleanupWhenDone || !1, h), g.callback(null));
      };
      e.onerror = function () {
        ye(e, !0, h);
        var l = new ze(0, "Error while loading script " + d);
        ne(g);
        oe(g, !1, l);
      };
      f = b.attributes || {};
    ...
    xe = function () {
      if (this && this.script_) {
        var a = this.script_;
        a && a.tagName == "SCRIPT" && ye(a, !0, this.timeout_);
      }
    },
    ye = function (a, b, c) {
  ...
  Ce.prototype.get = function (a, b) {
    return De(this, "GET", a, null, b);
  };
  var De = function (a, b, c, d, e) {
      var f, g, h, k, l;
      return ya(function (n) {
        if (n.nextAddress == 1) return ra(n, Ee(), 2);
        f = A("gapi.client");
        g = A("gapi.config");
        h = Fe();
        k = f.getToken();
        ...
        l = f
          .request({
            ...
            path: c,
            method: b,
            body: d ? JSON.stringify(Hc(d)) : void 0,
            headers: {
    ...
    Ge = function (a) {
      for (
        var b = A("gapi.config"), c = w(Object.keys(a)), d = c.next();
        !d.done;
        d = c.next()
      )
    ...
    Ee = function () {
      return A("gapi.load")
        ...
        : Be().then(
            ...
            function (a) {
              return Yd("Failed initializing gapi.\nGapi error: " + a);
            },
          );
    },
    He = function () {
  ...
  W.prototype.getSeconds = function () {
    var a = a === void 0 ? Rc : a;
    var b = bb ? Uc(this, 1, void 0, void 0, xc) : xc(Uc(this, 1));
    return b != null ? b : a;
  };
  ...
  u(Je, Q);
  Je.prototype.getTimezoneOffset = function () {
    return L(this, W, 3);
  };
  Je.prototype.setTimezoneOffset = function (a) {
    return M(this, W, 3, a);
  };
  var Ke = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Ke, Q);
  Ke.prototype.setPlatform = function (a) {
    return K(this, 1, a == null ? a : nc(a), 0);
  };
  Ke.prototype.setSupportedCapabilityList = function (a) {
    return $c(this, 3, a, nc);
  };
  Ke.prototype.setLibraryVersionInt = function (a) {
  ...
  u(Le, Q);
  Le.prototype.setDeviceInfo = function (a) {
    return M(this, Je, 1, a);
  };
  Le.prototype.setLibraryInfo = function (a) {
  ...
  u(Me, Q);
  Me.prototype.getAllowedCompletionStyleList = function () {
    return dd(this);
  };
  var Ne = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Oe, Q);
  Oe.prototype.getPromptDelay = function () {
    return L(this, Ne, 1);
  };
  Oe.prototype.getAllowedPromptStyleList = function () {
    return dd(this);
  };
  var Pe = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Pe, Q);
  Pe.prototype.getLanguage = function () {
    return bd(this, 8);
  };
  Pe.prototype.getCompletion = function () {
    return L(this, Me, 2);
  };
  Pe.prototype.getDisplaySettings = function () {
    return L(this, Oe, 3);
  };
  var Qe = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Qe, Q);
  Qe.prototype.setIsScheduledSurvey = function (a) {
    return P(this, 1, a);
  };
  var Re = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Ue, Q);
  Ue.prototype.setTriggerContext = function (a) {
    return M(this, Te, 1, a);
  };
  Ue.prototype.setClientContext = function (a) {
    return M(this, Le, 2, a);
  };
  Ue.prototype.setScheduledSurveyContext = function (a) {
    M(this, Qe, 3, a);
  };
  var Ve = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  We.prototype.register = function (a, b, c) {
    this.actions_[a] = { callback: b, isApplicable: c || Rd };
  };
  ...
  We.prototype.isApplicable = function (a) {
    a = this.actions_[a];
  ...
  u(Ye, Q);
  Ye.prototype.setDirection = function (a) {
    return K(this, 8, I(a), "");
  };
  var Ze = (function (a) {
    return function (b) {
  ...
  function $e(a) {
    if (!a) return null;
    a = zc(Uc(a, 4, void 0, Sc));
    return a === null || a === void 0 ? null : Ta(a);
  }
  var af = x([""]),
    bf = x(["https://www.google.com/tools/feedback/help_panel_binary.js"]);
  function cf(a, b, c, d) {
    var e = a.helpCenterPath.startsWith("/")
        ? a.helpCenterPath.substring(1)
        : a.helpCenterPath,
      f = c.document,
      g = a.nonce,
      h = Ze(b);
    h = L(h, Xe, 10) ? $e(L(h, Xe, 10)) || S(af) : S(bf);
    var k = zd(f).createElement("SCRIPT");
  ...
  var df = x(["https://www.google.com/tools/feedback/"]),
    ef = x(["http://localhost.corp.google.com/inapp/"]),
    ff = x(["http://localhost.proxy.googlers.com/inapp/"]),
    gf = x(["https://asx-frontend-autopush.corp.google.com/inapp/"]),
    hf = x(["https://asx-frontend-autopush.corp.google.com/tools/feedback/"]),
    jf = x(["https://asx-frontend-autopush.corp.google.co.uk/inapp/"]),
    kf = x(["https://asx-frontend-autopush.corp.google.co.uk/tools/feedback/"]),
    lf = x(["https://asx-frontend-autopush.corp.google.de/inapp/"]),
    mf = x(["https://asx-frontend-autopush.corp.google.de/tools/feedback/"]),
    nf = x(["https://asx-frontend-autopush.corp.youtube.com/tools/feedback/"]),
    of = x(["https://asx-frontend-autopush.corp.youtube.com/inapp/"]),
    pf = x([
      "https://asx-help-frontend-autopush.corp.youtube.com/tools/feedback/",
    ]),
    qf = x(["https://asx-help-frontend-autopush.corp.youtube.com/inapp/"]),
    rf = x(["https://asx-frontend-staging.corp.google.com/inapp/"]),
    sf = x(["https://asx-frontend-staging.corp.google.com/tools/feedback/"]),
    tf = x(["https://support.google.com/inapp/"]),
    uf = x(["https://sandbox.google.com/inapp/"]),
    vf = x(["https://sandbox.google.com/tools/feedback/"]),
    wf = x(["https://www.google.cn/tools/feedback/"]),
    xf = x(["https://help.youtube.com/tools/feedback/"]),
    yf = x(["https://asx-frontend-staging.corp.google.com/inapp/"]),
    zf = x(["https://asx-frontend-staging.corp.google.com/tools/feedback/"]),
    Af = x(["https://localhost.corp.google.com/inapp/"]),
    Bf = x(["https://localhost.proxy.googlers.com/inapp/"]),
    Cf = S(df),
    Df = [S(ef), S(ff)],
    Ef = [S(gf), S(hf), S(jf), S(kf), S(lf), S(mf), S(nf), S(of), S(pf), S(qf)],
    Ff = [S(rf), S(sf)],
    Gf = [Cf, S(tf), S(uf), S(vf), S(wf), S(xf), S(yf), S(zf), S(Af), S(Bf)];
  la(Df);
  la(Ef);
  la(Ff);
  la(Gf);
  ...
  Hf.prototype[Symbol.dispose] = function () {
    this.dispose();
  };
  Hf.prototype.disposeInternal = function () {
  ...
  Kf.prototype.init = function (a, b) {
    ...
    this.event_ = a;
    a.defaultPrevented && Kf.superClass_.preventDefault.call(this);
  };
  Kf.prototype.stopPropagation = function () {
    Kf.superClass_.stopPropagation.call(this);
    this.event_.stopPropagation
      ? this.event_.stopPropagation()
      : (this.event_.cancelBubble = !0);
  };
  Kf.prototype.preventDefault = function () {
    Kf.superClass_.preventDefault.call(this);
    var a = this.event_;
    a.preventDefault ? a.preventDefault() : (a.returnValue = !1);
  };
  var Pf = "closure_listenable_" + ((Math.random() * 1e6) | 0);
  var Qf = 0;
  ...
  Tf.prototype.add = function (a, b, c, d, e) {
    var f = a.toString();
    a = this.listeners[f];
    ...
    g > -1
      ...
      : ((b = new Rf(b, this.src, f, !!d, e)), (b.callOnce = c), a.push(b));
    return b;
  };
  Tf.prototype.remove = function (a, b, c, d) {
    a = a.toString();
  ...
  Tf.prototype.hasListener = function (a, b) {
    var c = a !== void 0,
      d = c ? a.toString() : "",
      e = b !== void 0;
    return gd(this.listeners, function (f) {
      for (var g = 0; g < f.length; ++g)
  ...
  var Wf = "closure_lm_" + ((Math.random() * 1e6) | 0),
    Xf = {},
    Yf = 0,
    $f = function (a, b, c, d, e) {
      if (d && d.once) Zf(a, b, c, d, e);
      ...
      if (Array.isArray(b))
        ...
        ((d = Ja(d) ? !!d.capture : !!d),
          ...
          a && a[Pf]
            ...
            : a && (a = cg(a)) && (b = a.getListener(b, c, d, e)) && hg(b));
    },
    hg = function (a) {
      if (typeof a !== "number" && a && !a.removed) {
        var b = a.src;
        if (b && b[Pf]) Vf(b.eventTargetListeners_, a);
        else {
          var c = a.type,
            d = a.proxy;
          b.removeEventListener
            ...
            : b.detachEvent
              ? b.detachEvent(eg(c), d)
              : b.addListener && b.removeListener && b.removeListener(d);
          Yf--;
          (c = cg(b))
            ? (Vf(c, a), c.typeCount_ == 0 && ((c.src = null), (b[Wf] = null)))
            : Sf(a);
        }
      }
    },
    ...
    cg = function (a) {
      a = a[Wf];
      return a instanceof Tf ? a : null;
    },
    ig = "__closure_events_fn_" + ((Math.random() * 1e9) >>> 0),
    ag = function (a) {
  ...
  var jg = function () {
    Hf.call(this);
    this.eventTargetListeners_ = new Tf(this);
  ...
  m.dispatchEvent = function (a) {
    ...
    d = a.type || a;
    if (typeof a === "string") a = new If(a, b);
    else if (a instanceof If) a.target = a.target || b;
    else {
      var e = a;
      a = new If(d, b);
      id(a, e);
    ...
    a.propagationStopped_ ||
      ((g = a.currentTarget = b),
      (e = kg(g, d, !0, a) && e),
      a.propagationStopped_ || (e = kg(g, d, !1, a) && e));
    if (c)
      for (f = 0; !a.propagationStopped_ && f < c.length; f++)
        ((g = a.currentTarget = c[f]), (e = kg(g, d, !1, a) && e));
    return e;
  };
  m.disposeInternal = function () {
    ...
    if (this.eventTargetListeners_) {
      ...
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) (++b, Sf(d[e]));
  ...
  var kg = function (a, b, c, d) {
    ...
    for (var e = !0, f = 0; f < b.length; ++f) {
      ...
      if (g && !g.removed && g.capture == c) {
        var h = g.listener,
          k = g.handler || g.src;
        g.callOnce && Vf(a.eventTargetListeners_, g);
        e = h.call(k, d) !== !1 && e;
      }
    }
  ...
  jg.prototype.hasListener = function (a, b) {
    return this.eventTargetListeners_.hasListener(
      a !== void 0 ? String(a) : void 0,
      b,
    );
  };
  var lg = function (a) {
  ...
  m.send = function (a, b, c, d) {
    ...
    this.xhr_.onreadystatechange = T(Ma(this.onReadyStateChange_, this));
    this.progressEventsEnabled_ &&
      ...
      this.xhr_.upload &&
        (this.xhr_.upload.onprogress = T(Ma(this.onProgressHandler_, this))));
    try {
      ((this.inOpen_ = !0),
    ...
    try {
      (this.timeoutId_ &&
        (clearTimeout(this.timeoutId_), (this.timeoutId_ = null)),
        this.timeoutInterval_ > 0 &&
          (this.timeoutId_ = setTimeout(
            this.timeout_.bind(this),
  ...
  X.prototype.onReadyStateChange_ = function () {
    if (!this.isDisposed())
      if (this.inOpen_ || this.inSend_ || this.inAbort_) ug(this);
  ...
  var ug = function (a) {
    if (a.active_ && typeof Da != "undefined")
      if (a.inSend_ && vg(a) == 4) setTimeout(a.onReadyStateChange_.bind(a), 0);
      else if ((a.dispatchEvent("readystatechange"), vg(a) == 4)) {
        a.active_ = !1;
        try {
          try {
            var b = vg(a) > 2 ? a.xhr_.status : -1;
          } catch (g) {
            b = -1;
          }
          a: switch (b) {
          ...
          if (!(d = c)) {
            var e;
            if ((e = b === 0)) {
              var f = String(a.lastUri_).match(mg)[1] || null;
              !f &&
                z.self &&
                z.self.location &&
                (f = z.self.location.protocol.slice(0, -1));
              e = !og.test(f ? f.toLowerCase() : "");
            }
            d = e;
          }
          d ? (a.dispatchEvent("complete"), a.dispatchEvent("success")) : sg(a);
        } finally {
          tg(a);
        }
      }
  ...
  X.prototype.getResponseHeader = function (a) {
    if (this.xhr_ && vg(this) == 4)
      return ((a = this.xhr_.getResponseHeader(a)), a === null ? void 0 : a);
  };
  X.prototype.getAllResponseHeaders = function () {
    return this.xhr_ && vg(this) >= 2
      ? this.xhr_.getAllResponseHeaders() || ""
      : "";
  };
  var yg = x([""]),
    zg = x(["https://www.google.com/tools/feedback/help_panel_binary.js"]);
  ...
  function Bg(a, b, c, d) {
    ...
    h && g !== 1
      ? (h = void 0)
      : g !== 1 || (h && !N(f, 5)) || ((g = 0), (h = void 0));
    k && g !== 2
      ? (g = 2)
      : g !== 2 || (k && !a.anchor) || ((g = 0), (k = void 0));
    ...
    var q = c.document,
      r = a.nonce,
      p = L(f, Xe, 10) ? $e(L(f, Xe, 10)) || S(yg) : S(zg),
    ...
    a.helpPanelTheme === 2 &&
      (O =
        c.matchMedia && c.matchMedia("(prefers-color-scheme: dark)").matches
          ? 1
          : 0);
    v = zd(q).createElement("SCRIPT");
    ...
    v.onload = function () {
      c.startHelpPanel({
        ...
        onPromotedProductLinkClickCallback:
          a.onPromotedProductLinkClickCallback,
  ...
  for (
    ...
    var Gg = Fg.value;
    Dg[Gg] = Gg;
    for (var Hg = w(Cg[Gg]), Ig = Hg.next(); !Ig.done; Ig = Hg.next())
      Dg[Ig.value] = Gg;
  }
  var Jg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Jg, Q);
  Jg.prototype.getTimezoneOffset = function () {
    return L(this, W, 3);
  };
  Jg.prototype.setTimezoneOffset = function (a) {
    return M(this, W, 3, a);
  };
  var Kg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Kg, Q);
  Kg.prototype.setPlatform = function (a) {
    return K(this, 1, a == null ? a : nc(a), 0);
  };
  Kg.prototype.setSupportedCapabilityList = function (a) {
    return $c(this, 3, a, nc);
  };
  Kg.prototype.setLibraryVersionInt = function (a) {
    return K(this, 4, a == null ? a : pc(a), 0);
  };
  var Lg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Lg, Q);
  Lg.prototype.setDeviceInfo = function (a) {
    return M(this, Jg, 1, a);
  };
  Lg.prototype.setLibraryInfo = function (a) {
  ...
  u(Mg, Q);
  Mg.prototype.getAllowedCompletionStyleList = function () {
    return dd(this);
  };
  var Ng = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Og, Q);
  Og.prototype.getPromptDelay = function () {
    return L(this, Ng, 1);
  };
  Og.prototype.getAllowedPromptStyleList = function () {
    return dd(this);
  };
  var Pg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Pg, Q);
  Pg.prototype.getLanguage = function () {
    return bd(this, 8);
  };
  Pg.prototype.getCompletion = function () {
    return L(this, Mg, 2);
  };
  Pg.prototype.getDisplaySettings = function () {
    return L(this, Og, 3);
  };
  var Qg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  u(Qg, Q);
  Qg.prototype.setIsScheduledSurvey = function (a) {
    return P(this, 1, a);
  };
  var Rg = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  Wg.prototype.setApiKey = function (a) {
    return K(this, 2, I(a), "");
  };
  Wg.prototype.setPlatform = function (a) {
  ...
  u($g, Q);
  $g.prototype.setTriggerContext = function (a) {
    return M(this, Vg, 1, a);
  };
  $g.prototype.setClientContext = function (a) {
    return M(this, Lg, 2, a);
  };
  $g.prototype.setScheduledSurveyContext = function (a) {
    M(this, Qg, 3, a);
  };
  var ah = function (a) {
    this.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows = J(a);
  ...
  function ch() {
    ...
    function b(q) {
      ...
      for (p = 0; p < 80; p++) {
        ...
        ma =
          ((((q << 5) | (q >>> 27)) & 4294967295) + ma + sb + Ha + r[p]) &
          4294967295;
        sb = O;
        O = D;
    ...
    function d() {
      ...
      b(f);
      for (p = r = 0; p < 5; p++)
        for (var v = 24; v >= 0; v -= 8) q[r++] = (e[p] >> v) & 255;
      return q;
    }
  ...
  var eh = function (a, b, c) {
      ...
      return d && a && b ? [b, dh(bh(d), a, c || null)].join(" ") : null;
    },
    dh = function (a, b, c) {
      var d = [],
        e = [];
  ...
  m.clear = function () {
    for (var a = hh(this).keys, b = a.length - 1; b >= 0; b--)
      this.remove(a[b]);
  };
  var hh = function (a) {
  ...
  var ih = function (a, b, c, d) {
    (a = z[a]) || typeof document === "undefined" || (a = new gh().get(b));
    return a ? eh(a, c, d) : null;
  };
  function jh(a) {
    Ob(a);
    Ub(a);
  ...
  function sh(a, b) {
    ...
    d = d && ph.includes(d) ? d : c && ph.includes(c) ? c : void 0;
    ...
    var f;
    return (
      b == null ? 0 : (f = b.getEnableAlohaBinarySplit) == null ? 0 : f.call(b)
    )
      ? S(qh, a)
      : S(rh, a, d);
  }
    ...
    return (uh = b.feedbackV2GlobalObject
      ...
      : new Promise(function (f, g) {
          ...
          h.onerror = function () {
            g(
              Error(
                "Feedback binary script tag failed to load: " + e.toString(),
              ),
            );
          };
  ...
  function zh(a, b, c, d) {
    ...
    xh = b;
    var e = sh(a, d);
    return (vh = b.feedbackV2GlobalObject
      ? Promise.resolve(b.feedbackV2GlobalObject)
      : new Promise(function (f, g) {
          var h = Dd(document, "SCRIPT");
          vd(h, e);
  ...
  function Ah(a, b, c, d, e) {
    ...
    return ya(function (n) {
      switch (n.nextAddress) {
        case 1:
          return ((f = Date.now()), ra(n, yh(a, c, d, b), 2));
        case 2:
          g = n.yieldResult;
          if (
            !(
  ...
  function Bh(a, b, c, d) {
    ...
    return ya(function (h) {
      if (h.nextAddress == 1)
        return ((e = Date.now()), ra(h, zh(a, c, d.document, b), 2));
      if (h.nextAddress != 3)
        return (
          (f = h.yieldResult),
  ...
  function Ch(a, b, c) {
    ...
    return ya(function (r) {
      ...
      if (
        (f = b) == null
          ? 0
          : (h = (g = f).getEnableAlohaBinarySplit) == null
            ? 0
            : h.call(g)
      ) {
        k = e;
        if (k.isFormOpened) throw new th();
        k.isFormOpened = !0;
        ...
        try {
          return r.return(Bh(a, b, k, e));
        } catch (p) {
          throw ((k.isFormOpened = !1), p);
        }
      } else {
        n = e;
        if (n.isFormOpened) throw new th();
        n.isFormOpened = !0;
        a.callbacks = a.callbacks || {};
        ...
        try {
          return r.return(Ah(a, b, n, e.document, d));
        } catch (p) {
  ...
  function Eh(a) {
    return nh(a) ? a : "https://www.google.com/tools/feedback";
  }
  var Fh = function (a, b, c) {
      a.timeOfStartCall = new Date().getTime();
      var d = c || z,
        e = d.document,
        f = a.nonce || ud(d.document);
      f && !a.nonce && (a.nonce = f);
      if (a.flow == "help") {
    ...
    Hh = function (a, b, c) {
      try {
        if (a.flow === "help") {
          ...
          td(c || window, "https://support.google.com/" + d);
        } else
          a.flow === "submit"
            ? Fh(a, b, c)
            : Dh(a.productId, a.feedbackServerUri).then(
                function (e) {
                  e = L(e, kh, 1);
                  var f = !jb || (e == null ? void 0 : e.getEnableMweb()),
                    g =
                      !a.tinyNoPointer ||
                      (e == null ? void 0 : e.getEnableTinyNoPointer());
                  !e || (e.getAlohaAutoGaRollout() && f && g)
                    ? Gh(a, b, c, e).catch(function (h) {
                        !h || h instanceof th || Fh(a, b, c);
                      })
                    : Fh(a, b, c);
                },
                function (e) {
                  !e || e instanceof th || Fh(a, b, c);
                },
              );
      } catch (e) {
        Gh(a, b, c, null).catch(function (f) {
          !f || f instanceof th || Fh(a, b, c);
        });
      }
    };
  Ea("userfeedback.api.startFeedback", Hh);
  function Ih(a, b) {
    var c = md(a);
    if (!Jh.test(c)) throw Error("Invalid TrustedResourceUrl format: " + c);
    a = c.replace(Kh, function (d, e) {
      ...
      d = b[e];
      return d instanceof ld ? md(d) : encodeURIComponent(String(d));
    });
    return Ta(a);
  }
  var Kh = /%{(\w+)}/g,
  ...
  var Mh = { done: !0, value: void 0 };
  Lh.prototype.__iterator__ = function () {
    return this;
  };
  function Nh(a) {
  ...
  function Oh(a) {
    this.elements_ = {};
    if (a) for (var b = 0; b < a.length; b++) this.elements_[Ph(a[b])] = null;
    for (var c in Object.prototype);
  }
  var Qh = {},
    Ph = function (a) {
      return a in Qh || String(a).charCodeAt(0) == 32 ? " " + a : a;
    },
    Rh = function (a) {
  ...
  m.forEach = function (a, b) {
    for (var c in this.elements_) a.call(b, Rh(c), void 0, this);
  };
  m.values = Object.keys
    ? function () {
        return Object.keys(this.elements_).map(Rh, this);
      }
    : function () {
        var a = [],
          b;
        for (b in this.elements_) a.push(Rh(b));
        return a;
      };
  m.getValues = function () {
    return this.values();
  ...
  var Vh = function (a) {
    ...
    if (a instanceof Vh) {
      ...
      Y(this);
      this.path_ = b;
      Yh(this, a.queryData_.clone());
      a = a.fragment_;
      Y(this);
      this.fragment_ = a;
    } else
      a && (b = String(a).match(mg))
        ? ((this.ignoreCase_ = !1),
          Wh(this, b[1] || "", !0),
          (a = b[2] || ""),
          Y(this),
          ...
          (this.fragment_ = Zh(a)))
        : ((this.ignoreCase_ = !1),
          (this.queryData_ = new $h(null, this.ignoreCase_)));
  };
  Vh.prototype.toString = function () {
    ...
    if (c || b == "file")
      (a.push("//"),
        (b = this.userInfo_) && a.push(ai(b, bi, !0), "@"),
        a.push(
    ...
    if ((c = this.path_))
      (this.domain_ && c.charAt(0) != "/" && a.push("/"),
        a.push(ai(c, c.charAt(0) == "/" ? ci : di, !0)));
    (c = this.queryData_.toString()) && a.push("?", c);
    (c = this.fragment_) && a.push("#", ai(c, ei));
    return a.join("");
  };
  Vh.prototype.resolve = function (a) {
    var b = this.clone(),
      c = !!a.scheme_;
    c ? Wh(b, a.scheme_) : (c = !!a.userInfo_);
    if (c) {
      var d = a.userInfo_;
      Y(b);
      b.userInfo_ = d;
    ...
    c ? Yh(b, a.queryData_.clone()) : (c = !!a.fragment_);
  ...
  var Wh = function (a, b, c) {
    ...
    Yh = function (a, b, c) {
      ...
      b instanceof $h
        ...
        : (c || (b = ai(b, fi)), (a.queryData_ = new $h(b, a.ignoreCase_)));
    };
  Vh.prototype.getQuery = function () {
    return this.queryData_.toString();
  };
  Vh.prototype.removeParameter = function (a) {
    Y(this);
  ...
  Vh.prototype.setIgnoreCase = function (a) {
    this.ignoreCase_ = a;
  ...
  var Zh = function (a, b) {
    ...
    hi = function (a) {
      a.keyMap_ ||
        ...
        (a.count_ = 0),
        a.encodedQuery_ &&
          ng(a.encodedQuery_, function (b, c) {
  ...
  m.getKeys = function () {
    ...
    for (
      var a = Array.from(this.keyMap_.values()),
        b = Array.from(this.keyMap_.keys()),
        c = [],
        d = 0;
      d < b.length;
      d++
  ...
  m.getValues = function (a) {
    ...
    var b = [];
    if (typeof a === "string")
      this.containsKey(a) && (b = b.concat(this.keyMap_.get(ii(this, a))));
    else {
  ...
  m.toString = function () {
    ...
    for (
      var a = [], b = Array.from(this.keyMap_.keys()), c = 0;
      c < b.length;
      c++
    ) {
      var d = b[c],
  ...
  m.clone = function () {
    ...
    this.keyMap_ &&
      ((a.keyMap_ = new Map(this.keyMap_)), (a.count_ = this.count_));
    return a;
  };
  var ii = function (a, b) {
    b = String(b);
  ...
  $h.prototype.setIgnoreCase = function (a) {
    a &&
      !this.ignoreCase_ &&
      (hi(this),
      (this.encodedQuery_ = null),
      this.keyMap_.forEach(function (b, c) {
        ...
        c != d &&
          ...
          b.length > 0 &&
            ((this.encodedQuery_ = null),
            this.keyMap_.set(ii(this, d), hb(b)),
  ...
  new Oh("svg SVG polygon POLYGON g G br BR".split(" "));
  function ji(a, b) {
    a = new Vh(a);
    return b === void 0 || b
      ? Wh(a, a.scheme_ || location.protocol).toString()
      : Wh(a, "http").toString();
  }
  var ki = x([
  ...
  var mi = function (a) {
    ...
    var e = [
      ...
      R(
        "https://feedback2-test.corp.googleusercontent.com/tools/feedback/%{resource}",
      ),
    ...
    a = ji(a, b === void 0 || !!b);
    a = Xa(qd(a));
    return Ih(R("//www.google.com/tools/feedback/%{resource}"), d);
  };
  ...
  var ni = function (a, b) {
    ...
    var d = Dd(document, "SCRIPT");
    c = mi({ serverUri: c });
    vd(d, c);
    window.document.body.appendChild(d);
  };
  Ea("userfeedback.api.help.loadChatSupport", ni);
  var oi = x([
    ...
    qi = Date.now(),
    ri =
      /uservoice\/surveys\/resources\/(non)?prod\/js\/survey\/survey_(dark|light)_(ltr|rtl)/gi,
    si =
      /uservoice\/surveys\/resources\/(non)?prod\/js\/survey\/survey_binary__/gi,
    Z = function (a, b) {
      this.productId_ = a;
      ...
      a: {
        if (
          (a = b.frdProductDataSerializedJspb || b.frdProductDataSerializedJspb)
        )
          try {
            var c = mb(a);
            break a;
        ...
        c = (c = b.frdProductData || b.frdProductData) ? ti(c) : void 0;
      }
      ...
      var d;
      (b = b.nonce || b.nonce) ||
        ((b = (d = this.window_) == null ? void 0 : d.document), (b = ud(b)));
      this.nonce_ = b;
      this.surveyStartupConfig_ = Zg(new Yg(), Ug(!1));
  ...
  m.startFeedback = function (a) {
    ...
    b && b();
    Hh(ui(this, a), this.productData_, this.window_);
  };
  ...
  m.updateContext = function (a) {
    ...
    b &&
      ...
      b.call(
        "help_panel_main_frame/help_panel_content_frame",
        "adaptContext",
        null,
        a,
      ));
  ...
  m.startHelp = function (a) {
    ...
    if (c && c.style.visibility === "hidden") {
      if (((c.style.visibility = "visible"), a.onRestoreCallback))
        a.onRestoreCallback();
    } else {
      c = new Date().getTime();
      var d = a ? vi(this, a, c) : {};
      ...
      try {
        Ag(
          ...
          if (f) {
            ...
            f.replaceChildren();
          } else Ed(document.getElementById("help_panel_main_frame"));
          Bg(d, JSON.stringify(Hc(e)), b.window_, b.productData_);
        });
      } catch (e) {
        td(window, "https://support.google.com/" + this.helpcenter);
      }
    }
  };
  m.startHelpCard = function (a, b) {
    ...
    try {
      Ag(
        ...
        var g;
        (g = document.getElementById("help_card_main_frame")) == null ||
          g.remove();
        cf(e, JSON.stringify(Hc(f)), c.window_, b || void 0);
      });
    } catch (f) {
      td(window, "https://support.google.com/" + this.helpcenter);
    }
  ...
  var ui = function (a, b) {
      ...
      return {
        ...
        enableAnonymousFeedback:
          b.enableAnonymousFeedback || b.enableAnonymousFeedback,
        allowNonLoggedInFeedback:
          b.allowNonLoggedInFeedback || b.allowNonLoggedInFeedback,
        tinyNoPointer: b.tinyNoPointer || b.tinyNoPointer,
        disableScreenshotAtStartup:
          b.disableScreenshotAtStartup || b.disableScreenshotAtStartup,
        disableScreenshotting:
          b.disableScreenshotting || b.disableScreenshotting,
    ...
    vi = function (a, b, c) {
      ...
      var e,
        ...
        sb = d.defaultHelpArticleId,
        ma = d.supportContentUrl,
        Ha = d.helpPanelTheme,
        Ci = d.nd4cSettings ? d.nd4cSettings.isEnabled : !1,
        Di = d.nd4cSettings ? d.nd4cSettings.countryCode : "",
        Ei = d.userIp ? d.userIp : "",
        Fi = d.defaultHelpArticleFragment,
        Gi = d.suggestHost,
        Hi = a.renderApiUri_,
        Ii = d.symptom,
        Ji = d.timezone,
        Ki = d.directToGetHelp || !1,
        Li =
          (e = d.helpGuideOptions) == null
            ? void 0
            : e.openToHelpGuideEntryButtonId;
      e = (f = d.helpGuideOptions) == null ? void 0 : f.enableHelpGuideMaximize;
      f =
        ((g = d.helpGuideOptions) == null
          ? void 0
          : g.enableHelpGuideConversationalAi) === !1
          ? !1
          : !0;
      g =
        (h = d.helpGuideOptions) == null ? void 0 : h.enableHelpGuideHumanChat;
      h = a.window_.location.protocol + "//" + a.window_.location.host;
      var Mi = d.helpPanelMode,
        Ni = d.fixedHelpPanelContainer,
        Oi = d.customHelpPanelContainer,
        Pi = a.frdProductDataBase64EncodedString_,
        Qi = d.onCloseCallback,
        Ri = d.onMinimizeCallback,
        Si = d.onLoadCallback,
        Ti = d.onPromotedProductLinkClickCallback,
        Ui = d.onGseEventCallback,
        Vi = d.openingMode,
        Wi = d.minimizeMode,
        Xi = (
          (k = d.helpGuideOptions) == null
            ? 0
            : k.helpGuideHelpCenterEmbedEntryPoint
        )
          ? ti(d.helpGuideOptions.helpGuideHelpCenterEmbedEntryPoint)
          : void 0;
      k = (
        (l = d.helpGuideOptions) == null ? 0 : l.helpGuideCommonEmbedEntryPoint
      )
        ? ti(d.helpGuideOptions.helpGuideCommonEmbedEntryPoint)
        : void 0;
      a: {
        var Lf;
        if (
          (Lf = d.helpGuideOptions) == null
            ? 0
            : Lf.helpGuideStartingFlowSerializedJspb
        )
          try {
            var Fd = mb(d.helpGuideOptions.helpGuideStartingFlowSerializedJspb);
            break a;
          } catch (Yi) {
            Fd = void 0;
            break a;
        ...
        var Mf;
        Fd = ((Mf = d.helpGuideOptions) == null ? 0 : Mf.helpGuideStartingFlow)
          ? ti(d.helpGuideOptions.helpGuideStartingFlow)
          : void 0;
      }
      a: {
        var Nf;
        if (
          (Nf = d.helpGuideOptions) == null
            ? 0
            : Nf.gseSessionOptionsSerializedJspb
        )
          try {
            var Gd = mb(d.helpGuideOptions.gseSessionOptionsSerializedJspb);
            break a;
          } catch (Yi) {
            Gd = void 0;
            break a;
        ...
        var Of;
        Gd = ((Of = d.helpGuideOptions) == null ? 0 : Of.gseSessionOptions)
          ? ti(d.helpGuideOptions.gseSessionOptions)
          : void 0;
      }
      a = {
        anchor: q,
        ...
        defaultHelpArticleId: sb,
        supportContentUrl: ma,
        helpPanelTheme: Ha,
        nd4cSettingsIsEnabled: Ci,
        nd4cSettingsCountryCode: Di,
        userIp: Ei,
        defaultHelpArticleFragment: Fi,
        newApi: !0,
        suggestHost: Gi,
        renderApiUri: Hi,
        symptom: Ii,
        timezone: Ji,
        directToGetHelp: Ki,
        openToHelpGuideEntryButtonId: Li,
        ...
        domain: h,
        helpPanelMode: Mi,
        fixedHelpPanelContainer: Ni,
        customHelpPanelContainer: Oi,
        frdProductData: Pi,
        onCloseCallback: Qi,
        onMinimizeCallback: Ri,
        onLoadCallback: Si,
        onPromotedProductLinkClickCallback: Ti,
        onGseEventCallback: Ui,
        openingMode: Vi,
        minimizeMode: Wi,
        helpGuideHelpCenterEmbedEntryPoint: Xi,
        helpGuideCommonEmbedEntryPoint: k,
        helpGuideStartingFlow: Fd,
        gseSessionOptions: Gd,
  ...
  m.loadChatSupport = function (a) {
    var b = a || {};
    a = a ? vi(this, a) : {};
    id(a, { escalationJSONString: b.escalationJSONString });
    ni(a, this.productData_);
  };
  m.requestSurvey = function (a) {
    if (!wi(a.triggerId)) throw Error("Invalid triggerId");
    var b = Date.now();
    xi(this, a, !1).then(
      function (c, d) {
        ...
        if (e) {
          var f = yi(e),
            g;
          d.getSession() && Se(d.getSession()) && (g = Se(d.getSession()));
          var h = {
            surveyData: {
              surveyData: JSON.stringify(Hc(d)),
              ...
              feedback1pEnabled: Tg(L(this.surveyStartupConfig_, Sg, 1)),
              thirdPartyDomainSupportEnabled:
                this.thirdPartyDomainSupportEnabled_,
            },
            triggerId: a.triggerId,
            surveyError: null,
          };
  ...
  m.presentSurvey = function (a) {
    if (a.surveyData) {
      var b =
        ...
        a.surveyData.surveyData.surveyData
          ? a.surveyData.surveyData
          : a.surveyData;
      ...
      c = ed(Ve, b.surveyData).getSurveyPayload();
      a: if (
        ((d = a.promptStyle),
        ...
        if (c)
          if (
            ...
            if (
              ...
              c = S(pi, c, d, f);
              if (c instanceof Sa)
                ((e.href = Ua(c).toString()), (e.rel = "stylesheet"));
              else {
                if (wd.indexOf("stylesheet") === -1)
                  throw Error(
  ...
  m.isHelpActionApplicable = function (a) {
    return Zi().isApplicable(a);
  };
  var $i = function (a, b) {
      if (b.enableFeedback1pEndpoint && b.enableTestingMode)
        return (
          (a.surveyStartupConfig_ = Zg(new Yg(), Ug(!0))),
      ...
      var c = Xg(new Wg(), (a.productId_ || "").toString()).setPlatform(1);
      return De(b, "POST", "v1/survey/startup_config", c, Yg).then(
        function (d) {
          ...
          if (Tg(L(d, Sg, 1))) {
            ...
            var g = new Kg()
              ...
              h =
                ...
                b.preferredSurveyLanguageList.length > 0
                  ? b.preferredSurveyLanguageList
                  : [a.locale_];
            h = new Vg()
            ...
            f = new $g()
              .setTriggerContext(h)
              .setClientContext(new Lg().setDeviceInfo(f).setLibraryInfo(g));
            c != "" &&
              c != void 0 &&
              c == 1 &&
              f.setScheduledSurveyContext(new Qg().setIsScheduledSurvey(c));
            d = De(d, "POST", e, f, ah);
          } else d = bj(a, b, c);
          return d;
        },
    ...
    aj = function (a, b) {
      var c = [],
        d = bh(z == null ? void 0 : z.location.href);
      var e = [];
      var f;
      (f =
        z.__SAPISID ||
      ...
      f &&
        ...
        (f = f ? eh(f, d ? "SAPISIDHASH" : "APISIDHASH", c) : null) &&
          e.push(f),
        d &&
          ((d = ih("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", c)) &&
            e.push(d),
          (c = ih("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", c)) &&
            e.push(c)));
    ...
    bj = function (a, b, c) {
      ...
      b = new Ue()
        .setTriggerContext(a)
        .setClientContext(new Le().setDeviceInfo(f).setLibraryInfo(g));
      c != "" &&
        c != void 0 &&
        c == 1 &&
        b.setScheduledSurveyContext(new Qe().setIsScheduledSurvey(c));
      return De(d, "POST", e, b, Ve);
    },
    wi = function (a) {
    ...
    Bi = function (a, b, c) {
      var d = c.nonProd ? "nonprod" : "prod",
        e =
          c.language && Dg[c.language.toLowerCase()]
            ? Dg[c.language.toLowerCase()]
            : Dg[a.locale_.toLowerCase()];
      e = e && e.replace("-", "_");
      e === "fa" && (e = "en");
      ...
      window.hatsNextGlobalObject
        ...
        : ((e = document.createElement("script")),
          ...
          document.querySelector("[data-survey-binary]") ||
    ...
    ej = function (a, b) {
      a: {
        ...
        } else if (qi > b.triggerRequestTime) {
          a.listener &&
            a.listener.surveyPrompted &&
            a.listener.surveyPrompted(b, {
              reason:
                "Survey must be triggered after initializing the help API.",
            });
          c = !1;
          break a;
        }
    ...
    Zi = function () {
      ...
      a || ((a = new We()), Ea("help.globals.actions", a, top));
      return a;
    },
    cj = function (a) {
      return []
        .concat(la(document.getElementsByTagName("script")))
        .find(function (b) {
    ...
    Ai = function () {
      document.querySelectorAll("link[rel=stylesheet]").forEach(function (a) {
        ...
        (a == null
          ? 0
          : (b = a.getAttribute("href")) == null
            ? 0
            : b.match(ri)) && a.parentNode.removeChild(a);
      });
    },
    ti = function (a) {
      if (!a) return "";
      try {
        return mb(JSON.stringify(Hc(a)));
      } catch (b) {
    ...
    zi = function (a) {
      return []
        .concat(la(document.querySelectorAll("link[rel=stylesheet]")))
        .find(function (b) {
