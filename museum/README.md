# Museum of Computation (Quick entry)

This folder contains Minecraft-ready exhibits (logic gates, binary counters, and more) used for pedagogy and demonstrations.

Quick links

- Builds: [`museum/builds/logic-gates.json`](builds/logic-gates.json), [`museum/builds/binary-counter.json`](builds/binary-counter.json)
- Play schedule and testing: `MINECRAFT_PLAY_SCHEDULE.md`
