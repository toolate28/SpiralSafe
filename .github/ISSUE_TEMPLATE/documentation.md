...
- [ ] Clear Intent - Clarifies purpose/reasoning
- [ ] Natural Decomposition - Explains structure
- [ ] Networked Learning - Enables knowledge transfer
...
```bash
# Commands to test any code examples
./example-command.sh
```
...
- [ ] Change aligns with Safe Spiral principles
