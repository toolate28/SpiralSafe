...
class TestAwiPromptGen:
    ...
    def test_empty_history(self):
        ...
        assert len(result_none.content) > 0, "Result with None history should have content"
        ...
        assert len(result_empty.content) > 0, "Result with empty list should have content"
    ...
    def test_malformed_intents(self):
        ...
        assert len(result_long.content) > 0, "Long intent should produce content"
